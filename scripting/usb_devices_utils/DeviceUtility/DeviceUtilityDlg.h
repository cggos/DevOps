...
// DeviceUtilityDlg.h : header file
//
...
class CDeviceUtilityDlg : public CDialogEx
{
// Construction
public:
	CDeviceUtilityDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	enum { IDD = IDD_DEVICEUTILITY_DIALOG };
...
{
	IDS_INDICATOR_DEVICE_STATUS,
	IDS_INDICATOR_SYS_TIME
};

enum TIMER_ID{SYS_TIME};
